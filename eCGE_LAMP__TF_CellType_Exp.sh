...
DMRS=~/epigenome/bican/protein_coding/CGE_LAMP5_allLAMP5_dms2_hypo_merged.bed   # chr start end id (id is col 4)
...
OUT1="$WORKDIR/TFcellACC_to_dmrs_cge.tsv"
OUT3="$WORKDIR/TF__dmr_3col_cge.tsv"
: > "$OUT1"
: > "$OUT3"
