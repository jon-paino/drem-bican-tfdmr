...
DMRS=~/epigenome/bican/protein_coding/DRD1-EPHA4_dms2_hypo_merged.bed  # chr start end id (id is col 4)
...
OUT1="$WORKDIR/TFcellACC_to_dmrs_msn_epha4.tsv"
OUT3="$WORKDIR/TF__dmr_3col_msn_epha4.tsv"
: > "$OUT1"
: > "$OUT3"
